...
Here, the means represent that of population.

H0: There is no difference in population means of response time under incongruent and congruent scenarios, which can be mathematically represented as

HA: There is a difference in population means of the response time under incongruent and congruent scenarios, which can be mathematically represented as

H0: $$\mu_C = \mu_I$$

HA: $$\mu_C \neq \mu_I$$

The sample size is small and the population standard deviation is not known, so our test statistic has a t-distribution.
...
It further confirms our finding in line plot where we saw that each data poin has heigher value of Incongruent vs Congruent
 ...
 The p value for t = -8.04 taken from graphpad website 
